 ...
 * @typedef {import('@scintilla-network/signatures/src/types.js').PublicKey} PublicKey
 * @typedef {import('@scintilla-network/signatures/src/types.js').PrivateKey} PrivateKey
 * @typedef {import('@scintilla-network/signatures/src/types.js').Signature} Signature
 * @typedef {import('@scintilla-network/signatures/src/types.js').Signing} Signing
 */

import { bls12_381 as bls } from '@noble/curves/bls12-381';
import { isUint8Array } from '@scintilla-network/signatures/src/utils/types.js';
import { formatMessage } from '@scintilla-network/signatures/src/utils/format.js';
