 ...
 * @module
 */
import { abytes } from '@noble/ciphers/esm/_assert.js';
import { ghash, polyval } from '@noble/ciphers/esm/_polyval.js';
import { clean, complexOverlapBytes, concatBytes, copyBytes, createView, equalBytes, getOutput, isAligned32, overlapBytes, setBigUint64, u32, u8, wrapCipher, } from '@noble/ciphers/esm/utils.js';
const BLOCK_SIZE = 16;
